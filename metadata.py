...
def appmetadata() -> AppMetadata:
    ...
    metadata = AppMetadata(
        name="BART Text Summarizer",
        description="The CLAMS app aims to summarize text using BART model finetuned by large CNN news dataset",  # briefly describe what the purpose and features of the app
        app_license="Apache2",  # short name for a software license like MIT, Apache2, GPL, etc.
        identifier="bart-summarizer",  # should be a single string without whitespaces. If you don't intent to publish this app to the CLAMS app-directory, please use a full IRI format.
        url="https://github.com/clamsproject/app-bart-summarizer",  # a website where the source code and full documentation of the app is hosted
        # (if you are on the CLAMS team, this MUST be "https://github.com/clamsproject/app-text-summarizer"
