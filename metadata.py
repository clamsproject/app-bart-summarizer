...
def appmetadata() -> AppMetadata:
    ...
    metadata = AppMetadata(
        ...
        identifier="text-summarizer",  # should be a single string without whitespaces. If you don't intent to publish this app to the CLAMS app-directory, please use a full IRI format.
        url="https://github.com/clamsproject/app-text-summarizer",  # a website where the source code and full documentation of the app is hosted
